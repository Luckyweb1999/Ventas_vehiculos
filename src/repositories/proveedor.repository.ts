...
> {
  ...
  constructor(
    @inject('datasources.postgresSQL') dataSource: PostgresSqlDataSource, @repository.getter('VehiculoRepository') protected vehiculoRepositoryGetter: Getter<VehiculoRepository>,
  ) {
